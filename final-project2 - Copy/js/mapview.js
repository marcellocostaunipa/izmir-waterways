  ...
  for (let i = 0; i < izsuData.features.length; i++) {
    ...
    if (selectedDam === feature) {
      ...
      if (isSelectedDam) {
        ...
        slides[3].scrollIntoView({ behavior: "smooth" })
        isSelectedDam = false
      }
    }
...
function drawCoordinates() {
  ...
  mapview.fill(255)
  mapview.textSize(12)
  mapview.textAlign(CENTER, TOP)
  mapview.text("Lon: " + lon.toFixed(4) + ", Lat: " + lat.toFixed(4), mapview.mouseX, mapview.mouseY-25);
  mapview.cursor(CROSS);
}
}